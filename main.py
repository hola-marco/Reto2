...
# Menú interactivo
    ...
    while True:
        ...
        print("4. Historial")
        print("5. Salir")
        opcion = input("Seleccione una opcion: ")# Finalmente, se agrega el cliente al sistema de la veterinaria usando el método agregar_cliente
        if opcion == "1":# Si el usuario elige la opción 1, se solicitan los datos del client
            ...
            if mascota:
                ...
                # - Si se encuentra la mascota, se imprime su historial de servicios llamando a `mostrar_historial()`.
            else:
